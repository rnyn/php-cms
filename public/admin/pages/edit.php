...
?>
    ...
    <div id="content">
      ...
      <a class="back-link" href="<?php echo url_for('/admin/pages/index.php');
      ...
      <div class="page edit">
        ...
        <form action="<?php echo url_for('/admin/pages/edit.php?id=' .
      h(u($id))); ?>" method="post">
          <dl>
            <dt>Subject</dt>
        <dd>
          ...
          <dl>
            ...
            <dd>
              <select name="position">
                <option value="1"<?php for($i=1; $i <= $page_count; $i++) {
                    echo "<option value=\"{$i}\"";
                    if($page["position"] == $i) {
                      echo " selected";
                  }
